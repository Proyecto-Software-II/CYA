...
const Home = () => {
  ...
  const [newCancellationMessage, setNewCancellationMessage] = useState("");
        ...
        <Box p={2} display="flex" justifyContent="center">
          <TextField
            ...
            onChange={(e) => {
              ...
              setNewCancellationMessage(e.target.value);
            }}
          />
        </Box>
        <Alert severity="info">{newCancellationMessage}</Alert>
        <Box p={2} display="flex" justifyContent="center">
          <Button
            variant="contained"
            color="primary"
            ...
            onClick={() => {
              axios({
                ...
                data: {
                  message: newCancellationMessage,
                },
              }).then((res) => {
